...
void write_pa(){
    ...
    sprintf(temptemp, "rm %s/PAS/pannouncements/%02d_%02d_%04d_%02d_%02d.pa", homedir,day, month, year, gtk_spin_button_get_value_as_int (g_hourdial),gtk_spin_button_get_value_as_int (g_minutedial));
